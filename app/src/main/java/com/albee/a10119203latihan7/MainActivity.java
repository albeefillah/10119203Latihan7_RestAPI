...
import com.albee.a10119203latihan7.view.caritempat.CariTempatFragment;
import com.albee.a10119203latihan7.view.informasi.InformasiFragment;
import com.albee.a10119203latihan7.view.lokasisaya.LokasiSayaFragment;
import com.albee.a10119203latihan7.view.profile.ProfileFragment;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.nav_carikuliner:
                        ...
                        fm.beginTransaction()
                                .replace(R.id.container, new CariTempatFragment())
                                .commit();
                        drawerLayout.closeDrawer(GravityCompat.START);
                        break;
